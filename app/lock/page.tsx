      ...
      <div className="mx-auto max-w-4xl px-3 py-6">
        ...
        <div className="mb-6 grid gap-4 lg:grid-cols-2">
          ...
          >
            ...
            <div className="mb-4 font-mono text-lg text-[#c8d0e0]">
            ...
            {!activeLock ? (
              <div data-tour="tour-lock-form">
                ...
                <input
                  ...
                  min={10}
                  step={1}
                  className="mb-3 w-full border border-[#2a3140] bg-[#0c0e12] px-2 py-1.5 font-mono text-[10px] text-[#c8d0e0] outline-none focus:border-[#ffc107]"
                  value={lockAmount}
                ...
                <button
                  ...
                  className="mb-2 w-full border border-[#00c853] bg-[#0d1f14] py-2 text-[10px] font-mono uppercase text-[#00c853] hover:bg-[#122018]"
                >
                  Lock &amp; run
                </button>
                {lockUiError && (
                  <p className="mb-2 text-[10px] text-[#ff5252]">{lockUiError}</p>
                )}
          ...
          >
            ...
            <div className="max-h-[360px] overflow-y-auto">
              <div className="grid grid-cols-[1fr_1fr_1fr_1fr_1fr_1fr] gap-x-2 border-b border-[#1e2430] px-4 py-1.5 font-mono text-[10px] text-[#5c6578]">
                <span>TIME (UTC)</span>
                <span>SIDE</span>
              ...
              {activeLock?.trades.map((t) => (
                <div
                  key={t.id}
                  className="grid grid-cols-[1fr_1fr_1fr_1fr_1fr_1fr] gap-x-2 border-b border-[#1a1f28] px-4 py-1.5 font-mono text-[10px]"
                >
